...
BEGIN
	...
	IF v_curr_salary IS NOT NULL THEN
		UPDATE salaries 
		SET 
			to_date = SYSDATE() -- To check the current to_date whenever we invoke this query
		WHERE
...
-- Excercise: 2 : Check the hire_date of a employee is higher than current date, if true then set this date to be a current date with date in yy mm dd format. 
DELIMITER $$
...
INSERT INTO employees VALUES ('999904','1970-01-31','John','Guwalani','M','2025-01-01');
